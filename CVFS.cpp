...
void DisplayHelp()
{
    ...
    printf("start : To Display information of file using name\n");
    printf("fstart : To Display information of file Descriptor\n");
...
int main()
{
    ...
    while(1)
    {
        ...
        count = sscanf(str,"%s %s %s %s",command[0],command[1],command[2],command[3]); //return value 1
        
        //strtok //tokanization
        if(count == 1)
        {
            if(strcmp(command[0],"ls") == 0)  //strcmp :- stringCompair
            {
                ls_file();
            }
    ...
    else if(count == 3)
    {
        ...
        {
            ret = CreateFile(command[1],atoi(command[2])); //atoi - asci tointeger
            if(ret >= 0)
...
C:\Users\rajes\OneDrive\Desktop\LB>g++ CVFS.cpp -o Myexe

C:\Users\rajes\OneDrive\Desktop\LB>Myexe.exe
...
start : To Display information of file using name
fstart : To Display information of file Descriptor
...
Usage : write File_name
 ...
 Marvellous VFS : >man dfnrejgurhfd
...
Usage : create File_name permission
 ...
 Marvellous VFS : >create Marvellous.txt 3
...
File is successfully created with file descriptor : 1
 ...
 Marvellous VFS : >stat Marvellous.txt
...
Usage : write File_name
 ...
 Marvellous VFS : >write Marvellous.txt
Enter the data :
Hello World
...
File Name       Inode number    File size       Link count
-------------------------------------------------------
Marvellous.txt          1               11              1
Demo.txt                2               0               1
---------------------------------------------------------


 Marvellous VFS : >write PPA.txt
...
Usage : read File_name No_Of_Bytes_To_Read
 ...
 Marvellous VFS : >read Marvellous.txt 5
Hello
 Marvellous VFS : >read Marvellous.txt 7
 WorldD
 Marvellous VFS : >read Marvellous.txt 3
emo
